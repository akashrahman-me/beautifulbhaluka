...
class SocialRepositoryImpl : SocialRepository {
    ...
    override suspend fun getProfile(userId: String): Result<SocialProfile> {
        ...
        val profile = SocialProfile(
            ...
            userProfileImage = currentUserImage,
            coverImage = "https://source.unsplash.com/800x400/?nature",
    ...
    private fun generateMockPosts(): List<Post> {
        return listOf(
            Post(
                ...
                images = listOf("https://source.unsplash.com/800x600/?nature,bangladesh"),
                likes = 45,
                comments = 12,
                shares = 3,
                location = "ভালুকা, ময়মনসিংহ",
            ...
            Post(
                ...
                images = listOf(
                    "https://source.unsplash.com/800x600/?community,people",
                    "https://source.unsplash.com/800x600/?meeting,group"
                ),
                likes = 89,
                comments = 23,
                shares = 8,
            ...
            Post(
                ...
                images = listOf("https://source.unsplash.com/800x600/?sunset,sky"),
                likes = 234,
                comments = 34,
                shares = 15,
                location = "ভালুকা",
